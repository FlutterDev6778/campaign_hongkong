...
class ReferralPageStyles {
  ...
  ReferralPageStyles(BuildContext context) {}
}

class ReferralPageMobileStyles extends ReferralPageStyles {
  ReferralPageMobileStyles(BuildContext context) : super(context) {
    ...
    itemHeight = widthDp * 52;
    itemBorderRadius = widthDp * 10;
