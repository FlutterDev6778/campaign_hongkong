...
class _ChallengeListViewState extends State<ChallengeListView> {
  ...
  Widget build(BuildContext context) {
    widget.challengeListPanelStyles.windowHeight = widget.challengeListPanelStyles.deviceHeight -
        widget.challengeListPanelStyles.statusbarHeight -
        widget.challengeListPanelStyles.heightDp * (5 + 35 + 5 + 20 + 35 + 40);
    ...
    return Consumer<RegisterChallengeProvider>(builder: (context, registerChallengeProvider, _) {
      ...
      return Container(
        ...
        child: Column(
          children: [
            SizedBox(height: widget.challengeListPanelStyles.statusbarHeight),
            ...
            SizedBox(height: widget.challengeListPanelStyles.heightDp * 20),
        ...
        children: [
          ...
          (_registerChallengeProvider.registerChallengeState.step == 0)
              ? Container(
                  width: widget.challengeListPanelStyles.windowWidth,
                  height: widget.challengeListPanelStyles.windowHeight,
                  padding: EdgeInsets.symmetric(vertical: widget.challengeListPanelStyles.heightDp * 20),
                  alignment: Alignment.center,
                  child: Center(
                    child: SvgPicture.asset(
                      AppAssets.lineBackImage,
                      width: widget.challengeListPanelStyles.widthDp * 190,
  ...
  Widget _containerStartChallengePanel(BuildContext context) {
    return Container(
      ...
      padding: EdgeInsets.only(
        ...
        top: widget.challengeListPanelStyles.heightDp * 18,
        bottom: widget.challengeListPanelStyles.heightDp * 25,
      ),
      child: Column(
  ...
  Widget _containerRegisterChallengePanel(BuildContext context) {
    return Container(
      ...
      height: widget.challengeListPanelStyles.windowHeight,
      padding: EdgeInsets.only(
        top: widget.challengeListPanelStyles.heightDp * 20,
        bottom: widget.challengeListPanelStyles.heightDp * 25,
      ),
            ...
            children: [
              Container(
                padding: EdgeInsets.only(
                  left: (widget.challengeListPanelStyles.deviceWidth - widget.challengeListPanelStyles.windowWidth) / 2,
                  right: (widget.challengeListPanelStyles.deviceWidth - widget.challengeListPanelStyles.windowWidth) / 2 +
                      widget.challengeListPanelStyles.widthDp,
                ),
                child: Column(
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              ...
                              padding:
                                  EdgeInsets.only(left: widget.challengeListPanelStyles.heightDp * 85 + widget.challengeListPanelStyles.widthDp * 10),
                              ...
                              child: Column(
                                ...
                                children: [
                                  Container(
                                    ...
                                    padding: EdgeInsets.only(
                                        left: widget.challengeListPanelStyles.heightDp * 60 + widget.challengeListPanelStyles.widthDp * 10),
                                    alignment: Alignment.centerLeft,
                                    child: Column(
                                      mainAxisAlignment: MainAxisAlignment.center,
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      ...
                                      child: Center(
                                        child: Text(
                                          ...
                                          style: TextStyle(
                                            fontSize: widget.challengeListPanelStyles.fontSp * 13,
                                            color:
                                                _registerChallengeProvider.registerChallengeState.step == 1 ? Color(0xFF10FFED) : Color(0xFFFFDA10),
                                            fontFamily: "Avenir-HeavyOblique",
                                          ),
                                        ),
                                      ),
  ...
  Widget _containerCategory(BuildContext context) {
    return Container(
      padding: EdgeInsets.only(
        ...
        top: widget.challengeListPanelStyles.heightDp * 115,
      ),
      child: Column(
        children: [
          Transform.rotate(
